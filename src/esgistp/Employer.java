...
public class Employer {
	...
	public Employer(int id,String nom,String prenom,String sexe,String naissance,String typeEmp,double salairebrut,double primeDeplacement, double primeRisque,double primeLogement,double primeRendement) {
		this.id=id;
		this.nom=nom;
		this.prenom=prenom;
		this.sexe=sexe;
